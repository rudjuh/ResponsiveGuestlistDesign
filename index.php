                            ...
                            <div class="readNewsTable">
                                <ul class="readNewsRow">
                                    <li class="readNewsCellLeft">
                                        <div>
                                            <a href="" alt="read news"/><img
                                                src="http://guestlist.net/uploads/articles/2015/05/87699.png"/></a>
                                        </div>
                                        ...
                                        <ul>
                                            <li class="readNewsBox">
                                                <div style="overflow:hidden;width:135px;margin-left:20px;">
                                                    <a href="" alt="" width="135"><img
                                                            src="http://guestlist.net/uploads/articles/2015/05/87747.png"/></a>
                                                </div>
                                                <div class="articles-content">
                                                    ...
                                                    <p>The "Birthplace of British cinema" has been restored to its
                                                        former glory.</p>
                                                </div>
                                            </li>
                                        </ul>
            ...
            <div style="min-height:400px;">
                <div class="news-menu-right-title">
                    <h3>
                        ...
                        &nbsp;/&nbsp; <a href="javascript:void(0)" class="popular-title">HOT</a> &nbsp;/&nbsp; <a
                            href="javascript:void(0)" class="new-title">NEW</a>
                    </h3>
                    <br class="clr"/>
                </div>
                            ...
                            <figure>
                                <a class="clearfix" href="">
                                    <div class="articleItemListElementImgContainer">
                                        <img
                                            src="http://0.static.newspaper.guestlistmedia.net/uploads/articles/11/750_smallsquare.jpg"
                                            alt="" class="imgb" width="100%" height="100%"/>
                                    </div>
                                    <figcaption class="easeInOutAll200 ">
                                        <h4 class="articleItemListElementContent">'They could stop the...</h4>
                                        <a class="articleItemListElementContentText">The man that many claim
                                            invented...</a>
                                    </figcaption>
                                    <br class="clr"/>
                                </a>
...
>>>>>>> 49956bf1bf61b70c196e27a0f6e986be3387b465
